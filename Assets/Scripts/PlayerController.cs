...
public class PlayerController : MonoBehaviour
{
   ...
   private void CheckSurroundings()
   {
     ...
     /*Physics2D.OverlapCircle():
      Đây là một hàm của Unity dùng để kiểm tra xem có bất kỳ collider nào của các đối tượng khác chồng lấn với 
      một hình tròn đã cho hay không.
      Các tham số của hàm:
      groundCheck.position: Vị trí tâm của hình tròn kiểm tra.
      groundCheckRadius: Bán kính của hình tròn kiểm tra.
      whatIsGround: Layer mask chỉ định các layer mà hình tròn sẽ kiểm tra sự chồng lấn.
      */
   }
   ...
   /*
     hàm OnDrawGizmos là một hàm có sẵn trong Unity, 
     được cung cấp bởi lớp MonoBehaviour. 
